...
class TestUnits(unittest.TestCase):
    ...
    def test_atm_conversion(self):
        ...
        # value error raised when negative
        self.assertRaises(ValueError, un.atm_2_pascal, -1)
        self.assertRaises(ValueError, un.atm_2_bar, -1)
    ...
    def test_meter_conversion(self):
        ...
        # value error raised when negative
        self.assertRaises(ValueError, un.m_2_angstrom, -1)
    ...
    def test_mol_lit_conversion(self):
        ...
        # value error raised when negative
        self.assertRaises(ValueError, un.mol_lit_2_mol_angstrom, -1)
